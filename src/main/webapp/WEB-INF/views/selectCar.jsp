...
<jsp:include page="navbar.jsp">
  <jsp:param name="url1" value="viewReservations?id=${myid}" />
  ...
  <div class="row">
    <div class="mx-auto mt-5 col-sm-6">
      ...
      <form:form method="post" modelAttribute="newReservation">
        ...
        <a href="<spring:url value="/viewReservations?id=${myid}"/> "><button type="button" class="btn btn-warning">Annulla</button></a>
      </form:form>
    </div>
  </div>
</div>
